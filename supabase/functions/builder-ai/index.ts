...
function generatePageContent(pageType: string, c: ColorScheme, businessName: string): string {
  const pages: Record<string, string> = {
    ...
    dashboard: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><div><h1 style="font-size:1.8rem;font-weight:700">Dashboard</h1><p style="color:var(--text-muted);font-size:0.9rem">Bienvenido a ${businessName}</p></div><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Nuevo</button></div><div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1.2rem;margin-bottom:2rem"><div class="card" style="padding:1.5rem"><p style="color:var(--text-muted);font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.5rem">Ingresos</p><p style="font-size:2rem;font-weight:800" class="gradient-text">$24,580</p><p style="color:var(--primary-light);font-size:0.85rem;margin-top:0.3rem">↑ 12%</p></div><div class="card" style="padding:1.5rem"><p style="color:var(--text-muted);font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.5rem">Clientes</p><p style="font-size:2rem;font-weight:800" class="gradient-text">1,234</p><p style="color:var(--primary-light);font-size:0.85rem;margin-top:0.3rem">↑ 8%</p></div><div class="card" style="padding:1.5rem"><p style="color:var(--text-muted);font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.5rem">Pedidos</p><p style="font-size:2rem;font-weight:800" class="gradient-text">456</p><p style="color:var(--primary-light);font-size:0.85rem;margin-top:0.3rem">↑ 5%</p></div><div class="card" style="padding:1.5rem"><p style="color:var(--text-muted);font-size:0.8rem;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.5rem">Conversión</p><p style="font-size:2rem;font-weight:800" class="gradient-text">3.2%</p><p style="color:var(--primary-light);font-size:0.85rem;margin-top:0.3rem">↑ 0.5%</p></div></div><div class="card" style="padding:1.5rem"><h3 style="margin-bottom:1rem">Actividad Reciente</h3><div style="display:flex;flex-direction:column;gap:0.8rem"><div style="display:flex;justify-content:space-between;align-items:center;padding:0.8rem;background:var(--bg-alt);border-radius:var(--radius-sm)"><div><p style="font-size:0.9rem;font-weight:500">Nuevo pedido #1234</p><p style="color:var(--text-muted);font-size:0.8rem">Hace 5 min</p></div><span style="color:var(--primary-light);font-weight:600">$320</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:0.8rem;background:var(--bg-alt);border-radius:var(--radius-sm)"><div><p style="font-size:0.9rem;font-weight:500">Cliente registrado</p><p style="color:var(--text-muted);font-size:0.8rem">Hace 12 min</p></div><span style="color:var(--accent);font-weight:600">María G.</span></div><div style="display:flex;justify-content:space-between;align-items:center;padding:0.8rem;background:var(--bg-alt);border-radius:var(--radius-sm)"><div><p style="font-size:0.9rem;font-weight:500">Pago recibido</p><p style="color:var(--text-muted);font-size:0.8rem">Hace 30 min</p></div><span style="color:var(--primary-light);font-weight:600">$150</span></div></div></div></div></div>`,
    clients: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><h1 style="font-size:1.8rem;font-weight:700">Clientes</h1><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Agregar</button></div><div class="card" style="padding:0;overflow:hidden"><div style="padding:1rem 1.5rem;border-bottom:1px solid var(--border)"><input type="text" placeholder="Buscar clientes..." style="width:100%;padding:0.6rem 1rem;background:var(--bg-alt);border:1px solid var(--border);border-radius:var(--radius-sm);color:var(--text);font-size:0.9rem;outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='var(--border)'"/></div><table style="width:100%;border-collapse:collapse"><thead><tr style="border-bottom:1px solid var(--border)"><th style="text-align:left;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Nombre</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Email</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Estado</th><th style="text-align:right;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Total</th></tr></thead><tbody><tr style="border-bottom:1px solid var(--border)" onmouseover="this.style.background='var(--bg-alt)'" onmouseout="this.style.background='transparent'"><td style="padding:0.8rem 1.5rem"><div style="display:flex;align-items:center;gap:0.6rem"><div style="width:32px;height:32px;border-radius:50%;background:var(--gradient);display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:700;color:#fff">AG</div>Ana García</div></td><td style="padding:0.8rem 1rem;color:var(--text-muted)">ana@email.com</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#10b981 15%,transparent);color:#10b981">Activo</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$4,200</td></tr><tr style="border-bottom:1px solid var(--border)" onmouseover="this.style.background='var(--bg-alt)'" onmouseout="this.style.background='transparent'"><td style="padding:0.8rem 1.5rem"><div style="display:flex;align-items:center;gap:0.6rem"><div style="width:32px;height:32px;border-radius:50%;background:var(--gradient);display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:700;color:#fff">CL</div>Carlos López</div></td><td style="padding:0.8rem 1rem;color:var(--text-muted)">carlos@email.com</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#10b981 15%,transparent);color:#10b981">Activo</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$3,800</td></tr><tr onmouseover="this.style.background='var(--bg-alt)'" onmouseout="this.style.background='transparent'"><td style="padding:0.8rem 1.5rem"><div style="display:flex;align-items:center;gap:0.6rem"><div style="width:32px;height:32px;border-radius:50%;background:var(--gradient);display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:700;color:#fff">MR</div>María R.</div></td><td style="padding:0.8rem 1rem;color:var(--text-muted)">maria@email.com</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#f59e0b 15%,transparent);color:#f59e0b">Pendiente</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$2,950</td></tr></tbody></table></div></div></div>`,
    products: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><h1 style="font-size:1.8rem;font-weight:700">Productos</h1><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Agregar</button></div><div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:1.2rem">${["Producto Premium,49.99,📦","Producto Básico,19.99,🎁","Producto Pro,79.99,⭐","Pack Empresarial,149.99,💎"].map(p => { const [n,pr,ic]=p.split(","); return `<div class="card" style="padding:0;overflow:hidden"><div style="height:140px;background:var(--gradient-subtle);display:flex;align-items:center;justify-content:center;font-size:3rem;opacity:0.3">${ic}</div><div style="padding:1.2rem"><h3 style="font-size:1rem;margin-bottom:0.3rem">${n}</h3><p style="color:var(--primary-light);font-size:1.2rem;font-weight:700">$${pr}</p></div></div>`; }).join("")}</div></div></div>`,
    invoices: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><h1 style="font-size:1.8rem;font-weight:700">Facturas</h1><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Nueva</button></div><div class="card" style="padding:0;overflow:hidden"><table style="width:100%;border-collapse:collapse"><thead><tr style="border-bottom:1px solid var(--border)"><th style="text-align:left;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Nº</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Cliente</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Fecha</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Estado</th><th style="text-align:right;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Total</th></tr></thead><tbody><tr style="border-bottom:1px solid var(--border)"><td style="padding:0.8rem 1.5rem;font-weight:600">F-001</td><td style="padding:0.8rem 1rem">Ana García</td><td style="padding:0.8rem 1rem;color:var(--text-muted)">2024-01-15</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#10b981 15%,transparent);color:#10b981">Pagada</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$1,250</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:0.8rem 1.5rem;font-weight:600">F-002</td><td style="padding:0.8rem 1rem">Carlos López</td><td style="padding:0.8rem 1rem;color:var(--text-muted)">2024-01-18</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#f59e0b 15%,transparent);color:#f59e0b">Pendiente</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$3,450</td></tr><tr><td style="padding:0.8rem 1.5rem;font-weight:600">F-003</td><td style="padding:0.8rem 1rem">María R.</td><td style="padding:0.8rem 1rem;color:var(--text-muted)">2024-01-20</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#ef4444 15%,transparent);color:#ef4444">Vencida</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$890</td></tr></tbody></table></div></div></div>`,
    orders: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><h1 style="font-size:1.8rem;font-weight:700">Pedidos</h1><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Nuevo</button></div><div class="card" style="padding:0;overflow:hidden"><table style="width:100%;border-collapse:collapse"><thead><tr style="border-bottom:1px solid var(--border)"><th style="text-align:left;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Pedido</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Cliente</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Estado</th><th style="text-align:right;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Total</th></tr></thead><tbody><tr style="border-bottom:1px solid var(--border)"><td style="padding:0.8rem 1.5rem;font-weight:600">#1234</td><td style="padding:0.8rem 1rem">Ana G.</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#3b82f6 15%,transparent);color:#3b82f6">En proceso</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$320</td></tr><tr><td style="padding:0.8rem 1.5rem;font-weight:600">#1233</td><td style="padding:0.8rem 1rem">Carlos L.</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#10b981 15%,transparent);color:#10b981">Entregado</span></td><td style="padding:0.8rem 1.5rem;text-align:right;font-weight:600;color:var(--primary-light)">$150</td></tr></tbody></table></div></div></div>`,
    ...
    users: `<div style="padding:2rem;background:var(--bg);min-height:100vh"><div style="max-width:1200px;margin:0 auto"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2rem"><h1 style="font-size:1.8rem;font-weight:700">Usuarios</h1><button class="btn" style="padding:0.6rem 1.5rem;font-size:0.85rem">+ Nuevo</button></div><div class="card" style="padding:0;overflow:hidden"><table style="width:100%;border-collapse:collapse"><thead><tr style="border-bottom:1px solid var(--border)"><th style="text-align:left;padding:0.8rem 1.5rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Usuario</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Email</th><th style="text-align:left;padding:0.8rem 1rem;color:var(--text-muted);font-size:0.78rem;text-transform:uppercase">Rol</th></tr></thead><tbody><tr style="border-bottom:1px solid var(--border)"><td style="padding:0.8rem 1.5rem"><div style="display:flex;align-items:center;gap:0.6rem"><div style="width:32px;height:32px;border-radius:50%;background:var(--gradient);display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:700;color:#fff">JD</div>Juan Dev</div></td><td style="padding:0.8rem 1rem;color:var(--text-muted)">juan@email.com</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,var(--primary) 15%,transparent);color:var(--primary-light)">Admin</span></td></tr><tr><td style="padding:0.8rem 1.5rem"><div style="display:flex;align-items:center;gap:0.6rem"><div style="width:32px;height:32px;border-radius:50%;background:var(--gradient);display:flex;align-items:center;justify-content:center;font-size:0.7rem;font-weight:700;color:#fff">ML</div>María L.</div></td><td style="padding:0.8rem 1rem;color:var(--text-muted)">maria@email.com</td><td style="padding:0.8rem 1rem"><span style="padding:0.2rem 0.6rem;border-radius:99px;font-size:0.75rem;font-weight:600;background:color-mix(in srgb,#10b981 15%,transparent);color:#10b981">Editor</span></td></tr></tbody></table></div></div></div>`,
